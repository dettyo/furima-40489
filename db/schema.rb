...
ActiveRecord::Schema[7.0].define(version: 2024_04_03_055805) do
  ...
  create_table "furimas", charset: "utf8", force: :cascade do |t|
    ...
    t.integer "shipping_date_info_id", null: false
  ...
  create_table "order_infos", charset: "utf8", force: :cascade do |t|
